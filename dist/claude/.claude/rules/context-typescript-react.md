...
Extends types-and-state and boundaries with stack specifics. For anything rendered in a browser, load web-ui alongside this file.
...
- Rendering safety, UI states, focus management, and accessibility are in web-ui; they apply to React unchanged.
