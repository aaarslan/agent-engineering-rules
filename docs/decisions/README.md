...
- [V5 three-way todo comparison](5.0.0-three-way-todo.md): a separate v3.1.1/v5/baseline sample, qualified outcomes, frozen identities and limits.

The unreleased v4 decisions and engineering log remain at `af7803f21629e71f3b65036923fffd34277e8b0a` on `feature/AER0004`. Retrieve them with `git show <revision>:docs/decisions/<file>`. They are historical evidence, not current v5 requirements.
