...
- Updating: re-copy the distribution from a newer release. Everything under `.claude/`, `.agents/skills/`, and `agent-rules/` is generated and safe to replace wholesale; your glob and profile edits are the only local changes to re-apply.
