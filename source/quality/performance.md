...
Correct and clear first. Performance work requires measurement under the [universal contract](../kernel/contract.md); a violated requirement makes the fix a correctness matter, not speculative optimization.
