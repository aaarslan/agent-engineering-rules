...
related: [../design/boundaries.md, ../contexts/web-ui.md]
---
...
- Treat HTML as a context-specific sink. Browser DOM rendering is owned by [Web UI](../contexts/web-ui.md); never hand-roll an escaper, because incomplete entity or attribute handling creates injection sinks.
